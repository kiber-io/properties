...
import (
	...
	"github.com/kiber-io/properties/assert"
)
...
// GOMAXPROCS=1 go test -run='^$' -bench '^BenchmarkMerge$' github.com/kiber-io/properties
// goos: darwin
// goarch: arm64
// pkg: github.com/kiber-io/properties
...
// PASS
// ok  	github.com/kiber-io/properties	6.842s
